...
public class MolCanvas_settings extends MolCanvas_main {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backgroundB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MolCanvas_settings.this, MolCanvas_colorPicker.class);
        ...
        defaultB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MolCanvas_settings.this, MolCanvas_settings.class);
                startActivity(intent);
            }
        });
        ...
        backB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MolCanvas_settings.this, MolCanvas_main.class);
                startActivity(intent);
            }
        });
