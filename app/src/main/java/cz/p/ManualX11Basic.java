...
public class ManualX11Basic extends ShellTools {
...
//    private WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manualx11basic);
        ...
        pdfView.setPath(new File(getFilesDir()+"/docs/x11basic_manual.pdf")); //Normal File loaction
