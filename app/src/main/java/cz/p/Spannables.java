...
//                );
        ...
        String[] words_cyan = {"dock", "topo", "info", "thermo", "ir", "hess ", "reopt ", "autoIR ", "singlepoint ", "fragdist ", "atomshift ", "distthr_attr ", "fc_rep ", "fc_attr ", "etemp ", "-qcg ", "-msreact "};
        Integer argb_cyan = Color.parseColor("#7AD5E1");
        for (String word : words_cyan) {
            int substringStart=0;
            int start;
...
//                );
        ...
        String[] words_magenta = {"--cite ", "-xnam ", "--scratch ", "--niceprint ", "--T ", "--dry ", "--legacy ", "--sp ", "--ancopt ", "--v1 ", "--v2 ", "--v2i ", "--v3 ", "--v4 ", "--entropy ", "--protonate ", "--deprotonate ", "--tautomerize ", "--cregen ", "--qcg ", "--msreact ", "--optlev ", "--len ", "--mdlen ", "--shake ", "--tstep ", "--mddump ", "--vbdump ", "--zs ", "--nosz ", "--cross ", "--nocross ", "--norotmd ", "--tnmd ", "--mrest ", "--hflip ", "--noflip ", "--maxflip ", "--quick ", "--squick ", "--mquick ", "--nci ", "--wscal ", "--prop ", "--origin ", "--keepdir ", "--noreftopo ", "--noopt ", "--nopreopt ", "--wall ", "--wallxl ", "--wallxxl ", "--scthr ", "--ssthr ", "--trange ", "--tread ", "--ptot ", "--fscal ", "--sthr ", "--ithr ", "--ewin ", "--rthr ", "--ethr ", "--bthr ", "--pthr ", "--nmr ", "--eqv ", "--athr ", "--esort ", "--nowr ", "--subrmsd ", "--notopo ", "--cluster ", "--pccap ", "--nopcmin ", "--pcaex ", "--cinp ", "--constrain ", "--cbonds ", "--nocbonds ", "--cmetal ", "--cheavy ", "--clight ", "--fc ", "--zsort ", "--mdopt ", "--screen ", "--rrhoav ", "--rmsd ", "--rmsdheavy ", "--testtopo ", "--thermo ", "--for ", "--forall ", "--splitfile ", "--reactor ", "--grow ", "--ensemble ", "--gsolv ", "--nsolv ", "--nopreopt ", "--samerand ", "--wscal ", "--fixsolute ", "--nofix ", "--xtbiff ", "--normdock ", "--directed ", "--qcgmtd ", "--ncimtd ", "--mtd ", "--enslvl ", "--tstep ", "--vbdump ", "--norotmd ", "--tnmd ", "--mreset ", "---fin_opt_gfn2 ", "--nocff ", "--esolv ", "--nclus ", "--freqlvl ", "--freqscal ", "--msnbonds ", "--msnshifts ", "--msnshifts2 ", "---msnoattrh ", "--msmolbar ", "--msinchi ", "--mslargeprint ", "--msiso ", "--msnoiso ", "--msinput ", "--swel ", "--genpot ", "--genmtd ", "--fragopt ", "--ceh ", "--tblite ", "--ptb ", "--cosmo ", "--tmcosmo ", "--cpcmx ", "--raman ", "--alpha ", "--json ", "-j ", "-t ", "-c ", "-check ", "-p ", "-prod ", "-eonly ", "-e0 ", "-e1 ", "-qcp ", "-qcpath ", "-unity ", "-v ", "-verbose ", "-f ", "-file ", "-w ", "--width ", "--s ", "--cascades ", "-m ", "--min ", "-i ", "--mzmin ", "-p ", "--noisotope ", "-e ", "--exp ", "--iterations ", "--cycles ", "--bhess ", "--oniom ", "--cut ", "--ceasefiles ", "--wrtopo ", "--sp ", "--pocket ", "--nostack ", "--noangular ", "--fast ", "--atm ", "--stepr ", "--stepa ", "--maxgen ", "--maxparent ", "--nstack ", "--nfinal ", "--ensemble ", "--etemp ", "--iterations ", "-a ", "--acc ", "--opt ", "--gfn2 ", "--gfn1 ", "--gfnff ", "--help", "--version", "--uhf ", "-- ", "--gfn ", "--restart ", "--ohess ", "--hess ", "--scc ", "--grad ", "--vip ", "--vipea ", "--vomega ", "--vfukui ", "--esp ", "--stm ", "--metaopt ", "--path ", "--modef ", "--omd ", "--md ", "--metadyn ", "--siman ", "-c ", "--chrg ", "-u ", "--vparam ", "-alpb ", "--alpb ", "-g ", "-gbsa ", "--gbsa ", "--cma ", "--pop ", "--molden ", "--dipole ", "--wbo ", "--lmo ", "--fod ", "-I ", "--input ", "--namespace ", "--copy ", "--nocopy ", "--norestart ", "-p ", "--parallel ", "--define ", "--citation ", "--charge ", "--license", "-v ", "--verbose ", "-s ", "--silent ", "--strict ", "-h ", "--sthr ", "--temp ", "--turbomole ", "--orca ", "--dftb+ ", "--dftbplus ", "--born ", "-f ", "-chk ", "-ax ", "-e ", "-p ", "-lpt ", "-al ", "-be ", "-t ", "-rpa ", "-vectm ", "-xtb ", "-oldtda ", "-resp ", "-aresp ", "-optrot ", "-2PA ", "-s2s ", "-sf ", "-nto ", "-rw ", "-dual "};
