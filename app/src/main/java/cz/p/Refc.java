...
public class Refc extends DevMode {
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/SOLIDS/Ref_c.txt"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout40 = openFileOutput("Ref_c.txt", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout40);
                    outputWriter.write(BasFile40);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Ref_c.txt "+getFilesDir()+"/SOLIDS");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Refc.this, DevMode.class);
