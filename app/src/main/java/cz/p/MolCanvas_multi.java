...
public class MolCanvas_multi extends AppCompatActivity {
    ...
    private Button prevStructure;
    private Button nextStructure;
    public int SN = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.molcanvasmulti);
        ...
        exitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MolCanvas_multi.this, MainActivity.class);
        ...
        prevStructure = (Button) findViewById(R.id.prevStructure);
        prevStructure.setOnClickListener(prevStructureClick);
        nextStructure = (Button) findViewById(R.id.nextStructure);
        nextStructure.setOnClickListener(nextStructureClick);
    }
    ...
    protected void onStart() {
        super.onStart();
        zoom_scale = MolCanvas_preferences.get().getValue("zoom");
        String EnergyStr = exec("sed -n 1p "+getFilesDir()+"/xtb/multi/multistructure_1.txt");
        File TestFile = new File(getFilesDir()+"/xtb/multi/multistructure_"+SN+".txt");
        if (TestFile.exists()) {
            Energy.setText(" E = " + EnergyStr + " Eh (str. " + SN + ")");
        }
    }
    ...
    public void alertZmat(){
        ...
        EditText editText100 = new EditText(MolCanvas_multi.this);
        ...
        final AlertDialog dialog = new AlertDialog.Builder(MolCanvas_multi.this)
...
//                .setView(scrollview)
                ...
                .setPositiveButton("Update", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        ProgressDialog progressDialog2 = new ProgressDialog(MolCanvas_multi.this);
    ...
    private View.OnClickListener toDftbClick; {
        toDftbClick = new View.OnClickListener() {
            public void onClick(View v) {
                ProgressDialog progressDialog = new ProgressDialog(MolCanvas_multi.this);
                ...
                new Thread() {
                    public void run() {
                        ...
                        Intent intent = new Intent(MolCanvas_multi.this, Dftb.class);
                        startActivity(intent);
                        molCanvasView.setMoleculeRenderer(MolCanvas_canvasView.TRUE);
                        onFinish();
                    }
            ...
            public void onClick(View v) {
                ...
                new Thread() {
                    public void run() {
                        ...
                        Intent intent = new Intent(MolCanvas_multi.this, Mopac.class);
                        startActivity(intent);
                        molCanvasView.setMoleculeRenderer(MolCanvas_canvasView.TRUE);
                        onFinish();
                    }
            ...
            public void onClick(View v) {
                ...
                new Thread() {
                    public void run() {
                        ...
                        Intent intent = new Intent(MolCanvas_multi.this, Xtb.class);
                        startActivity(intent);
                        molCanvasView.setMoleculeRenderer(MolCanvas_canvasView.TRUE);
                        onFinish();
                    }
...

    {
        elmntButton = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(MolCanvas_multi.this, MolCanvas_multi_periodicTable.class);
                startActivity(intent);
            }
        };
    }
...

    {
        settingsButton = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(MolCanvas_multi.this, MolCanvas_multi_settings.class);
                startActivity(intent);
            }
        };
    }
    ...
    public View.OnClickListener prevStructureClick;
    {
        prevStructureClick = new View.OnClickListener() {
            public void onClick(View v) {
                int PrevNumberInt;
                PrevNumberInt = SN-1;
                File PrevFile = new File(getFilesDir()+"/xtb/multi/multistructure_"+PrevNumberInt+".xyz");

                if (PrevFile.exists()){
                    SN--;
                    // TODO Auto-generated method stub //
                    String XYZfile = exec("cat "+getFilesDir()+"/xtb/multi/multistructure_"+PrevNumberInt+".xyz");
                    try {
                        ...
                        for (MolCanvas_object object : MolCanvas_canvasView.zmat) {
                            if (object.getObjectType() == 1) {
                                MolCanvas_multi.generatedLabels.add(new MolCanvas_object(object.getAtomNumber1(), object.getAtomSymbol1(),
                                        MolCanvas_methods.getElementTextColor(object.getAtomSymbol1()),
                                        object.getAtomBorderColor1(), 0,
                                        MolCanvas_methods.Text_pix(MolCanvas_preferences.get().getValue("text_size"), MolCanvas_multi.zoom_scale,
                                                object.getAtom1Z_Ang()),
                                        object.getTouchTime(), object.getAtom1X_Ang(), object.getAtom1Y_Ang(),
                                        object.getAtom1Z_Ang(),
                                        object.getAtom1X_pix() + MolCanvas_preferences.get().getValue("text_shift_x_pix"),
                    ...
                    String EnergyStr = exec("sed -n 1p "+getFilesDir()+"/xtb/multi/multistructure_"+PrevNumberInt+".txt");
                    Energy.setText(" E = "+EnergyStr+" Eh (str. "+PrevNumberInt+")");
                    molCanvasView.setMoleculeRenderer(MolCanvas_canvasView.TRUE);
                } else {

                    File TestFile = new File(getFilesDir()+"/xtb/multi/multistructure_"+SN+".txt");
                    if (TestFile.exists()) {
                        Toast.makeText(getApplicationContext(), "This is the first structure.", Toast.LENGTH_SHORT).show();
                        String EnergyStr = exec("sed -n 1p " + getFilesDir() + "/xtb/multi/multistructure_" + SN + ".txt");
                        Energy.setText(" E = " + EnergyStr + " Eh (str. " + SN + ")");
                    } else {
                        Toast.makeText(getApplicationContext(), "No structure loaded.", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    public View.OnClickListener nextStructureClick;
    {
        nextStructureClick = new View.OnClickListener() {
            public void onClick(View v) {
                int NextNumberInt = SN+1;
                File NextFile = new File(getFilesDir()+"/xtb/multi/multistructure_"+NextNumberInt+".xyz");

                if (NextFile.exists()){
                    SN++;
                    // TODO Auto-generated method stub //
                    String XYZfile = exec("cat "+getFilesDir()+"/xtb/multi/multistructure_"+NextNumberInt+".xyz");
                    try {
                        while (XYZfile.contains("\t")){  //2 spaces
                            XYZfile = XYZfile.replace("\t", " "); //(2 spaces, 1 space)
                        }
                    ...
                    String EnergyStr = exec("sed -n 1p "+getFilesDir()+"/xtb/multi/multistructure_"+NextNumberInt+".txt");
                    Energy.setText(" E = "+EnergyStr+" Eh (str. "+NextNumberInt+")");
                    molCanvasView.setMoleculeRenderer(MolCanvas_canvasView.TRUE);
                } else {
                    File TestFile = new File(getFilesDir()+"/xtb/multi/multistructure_"+SN+".txt");
                    if (TestFile.exists()) {
                        Toast.makeText(getApplicationContext(), "This is the last structure.", Toast.LENGTH_SHORT).show();
                        String EnergyStr = exec("sed -n 1p " + getFilesDir() + "/xtb/multi/multistructure_" + SN + ".txt");
                        Energy.setText(" E = " + EnergyStr + " Eh (str. " + SN + ")");
                    } else {
                        Toast.makeText(getApplicationContext(), "No structure loaded.", Toast.LENGTH_SHORT).show();
