...
public class XBasic10 extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xbasic10);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/GCM3/DatabaseMakerGCM3_c.bas"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout70 = openFileOutput("DatabaseMakerGCM3_c.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout70);
                    outputWriter.write(BasFile70);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/DatabaseMakerGCM3_c.bas "+getFilesDir()+"/GCM3");
                try {
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(XBasic10.this, DevMode.class);
