...
public class CompssDftb extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compssdftb);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/PSEUDOPHASES/Comp_solid_solDFTB.par"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout30 = openFileOutput("Comp_solid_solDFTB.par", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout30);
                    outputWriter.write(BasFile30);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Comp_solid_solDFTB.par "+getFilesDir()+"/PSEUDOPHASES");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CompssDftb.this, DevMode.class);
