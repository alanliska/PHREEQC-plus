...
public class MolCanvas_multi_colorPicker extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
...

    {
        confirmButton = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MolCanvas_multi_colorPicker.this, MolCanvas_multi_settings.class);
