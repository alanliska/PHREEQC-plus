...
public class Empirical extends MainActivity {
...
//        label24 = (TextView) findViewById(R.id.label24);
		...
		String DatasetName = DatasetName1.replace(",",".");
                ...
                Intent intent = new Intent(Empirical.this, GCM1.class);
		...
		String DatasetName = DatasetName1.replace(",",".");
                ...
                Intent intent = new Intent(Empirical.this, GCM2.class);
                startActivity(intent);
            }
        });
		...
		String DatasetName = DatasetName1.replace(",",".");
                ...
                Intent intent = new Intent(Empirical.this, GCM3.class);
                startActivity(intent);
            }
        });

//        start_gcm4 = (Button) findViewById(R.id.start_gcm4);
//        start_gcm4.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//
//                String DatasetName0 = dataset.getText().toString();
...
//                }
//
//                Intent intent = new Intent(Empirical.this, GCM4.class);
//                startActivity(intent);
//            }
//        });
		...
		String DatasetName = DatasetName1.replace(",",".");
                ...
                Intent intent = new Intent(Empirical.this, MainActivity.class);
                startActivity(intent);
            }
        });
