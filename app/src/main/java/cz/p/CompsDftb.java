...
public class CompsDftb extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compsdftb);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/SOLUTION_SPECIES/Comp_sDFTB.par"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout30 = openFileOutput("Comp_sDFTB.par", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout30);
                    outputWriter.write(BasFile30);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Comp_sDFTB.par "+getFilesDir()+"/SOLUTION_SPECIES");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CompsDftb.this, DevMode.class);
