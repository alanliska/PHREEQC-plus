...
public class RefGCM4 extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.refgcm4);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/GCM4/Ref_GCM4.txt"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout50 = openFileOutput("Ref_GCM4.txt", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout50);
                    outputWriter.write(BasFile50);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Ref_GCM4.txt "+getFilesDir()+"/GCM4");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(RefGCM4.this, DevMode.class);
