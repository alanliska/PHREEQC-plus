...
public class SpectrumXTB extends Xtb {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            File GraphFile = new File(getFilesDir()+"/xtb/graph-series1.csv");
...
//            series.setColor(Color.BLUE);
        ...
        try {
            File GraphFile2 = new File(getFilesDir()+"/xtb/graph-series2.csv");
...
//            reader.readLine();  //skip second line of file
            ...
            LineGraphSeries<DataPoint> series2 = new LineGraphSeries<>(listDp2);
        ...
        try {
            File GraphFile3 = new File(getFilesDir()+"/xtb/graph-series3.csv");
...
//            reader.readLine();  //skip second line of file
            ...
            LineGraphSeries<DataPoint> series3 = new LineGraphSeries<>(listDp3);
        ...
        try {
            File GraphFile4 = new File(getFilesDir()+"/xtb/graph-series4.csv");
...
//            reader.readLine();  //skip second line of file
            ...
            LineGraphSeries<DataPoint> series4 = new LineGraphSeries<>(listDp4);
        ...
        try {
            File GraphFile5 = new File(getFilesDir()+"/xtb/graph-series5.csv");
...
//            reader.readLine();  //skip second line of file
            ...
            LineGraphSeries<DataPoint> series5 = new LineGraphSeries<>(listDp5);
        ...
        try {
            File GraphFile6 = new File(getFilesDir()+"/xtb/graph-series6.csv");
...
//            reader.readLine();  //skip second line of file
            ...
            LineGraphSeries<DataPoint> series6 = new LineGraphSeries<>(listDp6);
        ...
        try {
            File GraphFile7 = new File(getFilesDir()+"/xtb/graph-series7.csv");
...
//            reader.readLine();  //skip second line of file
            ...
            LineGraphSeries<DataPoint> series7 = new LineGraphSeries<>(listDp7);
        ...
        try {
            File GraphFile8 = new File(getFilesDir()+"/xtb/graph-series8.csv");
...
//            reader.readLine();  //skip second line of file
            ...
            LineGraphSeries<DataPoint> series8 = new LineGraphSeries<>(listDp8);
        ...
        try {
            File GraphFile9 = new File(getFilesDir()+"/xtb/graph-series9.csv");
...
//            reader.readLine();  //skip second line of file
            ...
            LineGraphSeries<DataPoint> series9 = new LineGraphSeries<>(listDp9);
        ...
        try {
            File GraphFile10 = new File(getFilesDir()+"/xtb/graph-series10.csv");
...
//            reader.readLine();  //skip second line of file
            ...
            LineGraphSeries<DataPoint> series10 = new LineGraphSeries<>(listDp10);
