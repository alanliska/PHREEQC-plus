...
public class MolCanvas_product_colorPicker extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
...

    {
        confirmButton = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MolCanvas_product_colorPicker.this, MolCanvas_product_settings.class);
