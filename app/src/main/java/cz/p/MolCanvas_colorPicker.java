...
public class MolCanvas_colorPicker extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
...

    {
        confirmButton = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MolCanvas_colorPicker.this, MolCanvas_settings.class);
