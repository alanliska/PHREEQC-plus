...
public class KineticsBiBi extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        processBiBi = (Button) findViewById(R.id.processBiBi);
        processBiBi.setOnClickListener(processBiBiClick);
...
//                            outputWriterNts.close();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE1 && data != null) {
            try {
                ...
                FileOutputStream fileout = openFileOutput("BiBi_TS.txt", MODE_PRIVATE);
                OutputStreamWriter outputWriter = new OutputStreamWriter(fileout);
    ...
    private View.OnClickListener ResetTSClick; {
        ...
        ResetTSClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                exec("rm "+getFilesDir()+"/BiBi_TS.txt");
    ...
    private View.OnClickListener processBiBiClick; {
...
//                startActivity(intent);
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(KineticsBiBi.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
    ...
    private View.OnClickListener AddTSiClick; {
        AddTSiClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(KineticsBiBi.this, AddTSBiBi.class);
                startActivity(intent);
            }
        };
    }
