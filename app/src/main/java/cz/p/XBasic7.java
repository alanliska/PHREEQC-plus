...
public class XBasic7 extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xbasic7);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/GCM2/DatabaseMakerGCM2.bas"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout70 = openFileOutput("DatabaseMakerGCM2.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout70);
                    outputWriter.write(BasFile70);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/DatabaseMakerGCM2.bas "+getFilesDir()+"/GCM2");
                try {
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(XBasic7.this, DevMode.class);
