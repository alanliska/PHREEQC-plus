...
public class ModifyXtbKinetics extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modifyxtbkinetics);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/XtbKinetics.bas"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout70 = openFileOutput("XtbKinetics.bas", MODE_PRIVATE);
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ModifyXtbKinetics.this, DevMode.class);
