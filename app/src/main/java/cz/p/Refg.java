...
public class Refg extends DevMode {
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/PHASES/Ref_g.txt"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout40 = openFileOutput("Ref_g.txt", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout40);
                    outputWriter.write(BasFile40);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Ref_g.txt "+getFilesDir()+"/PHASES");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Refg.this, DevMode.class);
