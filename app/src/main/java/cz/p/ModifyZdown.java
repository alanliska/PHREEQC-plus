...
public class ModifyZdown extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modifyzdown);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/Zdown.bas"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout70 = openFileOutput("Zdown.bas", MODE_PRIVATE);
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ModifyZdown.this, DevMode.class);
