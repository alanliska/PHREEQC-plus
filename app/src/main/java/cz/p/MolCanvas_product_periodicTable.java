...
public class MolCanvas_product_periodicTable extends MolCanvas_product {
        ...
        H =
                new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(MolCanvas_product_periodicTable.this, MolCanvas_product.class);
