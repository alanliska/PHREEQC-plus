...
public class ResumeActivityKin extends MainActivity {
...
//            public void onClick(View v) {
    public void cleanOpenbabel() {
        ...
        progressDialog = new ProgressDialog(ResumeActivityKin.this);
...
//        exec("rm "+getFilesDir()+"/output/phreeqc_datasets"+File.separator+"hydrocarbons-PM7_g.txt");
    ...
    public void goBack()
    {
        Intent intent = new Intent(ResumeActivityKin.this, MainActivity.class);
