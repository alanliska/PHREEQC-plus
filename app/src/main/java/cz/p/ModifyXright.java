...
public class ModifyXright extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modifyxright);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/Xright.bas"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout70 = openFileOutput("Xright.bas", MODE_PRIVATE);
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ModifyXright.this, DevMode.class);
