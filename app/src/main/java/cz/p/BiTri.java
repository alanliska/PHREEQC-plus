...
public class BiTri extends DevMode {
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/BiTri.bas"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout40 = openFileOutput("BiTri.txt", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout40);
                    outputWriter.write(BasFile40);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/BiTri.txt "+getFilesDir()+"/BiTri.bas");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(BiTri.this, DevMode.class);
