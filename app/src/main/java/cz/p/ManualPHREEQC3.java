...
public class ManualPHREEQC3 extends Phreeqc {
...
//    private WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manualphreeqc3);
        ...
        pdfView.setPath(new File(getFilesDir()+"/docs/phreeqc_manual3.pdf")); //Normal File loaction
