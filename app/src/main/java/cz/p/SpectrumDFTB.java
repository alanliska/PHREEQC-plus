...
public class SpectrumDftb extends Dftb {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            File GraphFile = new File(getFilesDir()+"/dftb/graph-series1.csv");
...
//            series.setColor(Color.BLUE);
        ...
        try {
            File GraphFile2 = new File(getFilesDir()+"/dftb/graph-series2.csv");
...
//            reader.readLine();  //skip second line of file
        ...
        try {
            File GraphFile3 = new File(getFilesDir()+"/dftb/graph-series3.csv");
...
//            reader.readLine();  //skip second line of file
        ...
        try {
            File GraphFile4 = new File(getFilesDir()+"/dftb/graph-series4.csv");
...
//            reader.readLine();  //skip second line of file
        ...
        try {
            File GraphFile5 = new File(getFilesDir()+"/dftb/graph-series5.csv");
...
//            reader.readLine();  //skip second line of file
        ...
        try {
            File GraphFile6 = new File(getFilesDir()+"/dftb/graph-series6.csv");
...
//            reader.readLine();  //skip second line of file
        ...
        try {
            File GraphFile7 = new File(getFilesDir()+"/dftb/graph-series7.csv");
...
//            reader.readLine();  //skip second line of file
        ...
        try {
            File GraphFile8 = new File(getFilesDir()+"/dftb/graph-series8.csv");
...
//            reader.readLine();  //skip second line of file
        ...
        try {
            File GraphFile9 = new File(getFilesDir()+"/dftb/graph-series9.csv");
...
//            reader.readLine();  //skip second line of file
        ...
        try {
            File GraphFile10 = new File(getFilesDir()+"/dftb/graph-series10.csv");
