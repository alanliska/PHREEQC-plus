...
public class ManualPHREEQCplus extends MainActivity {
...
//    private WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manualphreeqcplus);
        ...
        pdfView.setPath(new File(getFilesDir()+"/docs/phreeqc_plus_manual.pdf")); //Normal File loaction
