...
public class MolCanvas_reactant_periodicTable extends MolCanvas_reactant {
        ...
        H =
                new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(MolCanvas_reactant_periodicTable.this, MolCanvas_reactant.class);
