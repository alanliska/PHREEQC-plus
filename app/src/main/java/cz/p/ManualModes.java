...
public class ManualModes extends Dftb {
...
//    private WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manualmodes);
        ...
        pdfView.setPath(new File(getFilesDir()+"/docs/modes_manual.pdf")); //Normal File loaction
