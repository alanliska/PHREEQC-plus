...
public class DatGCM2 extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.datgcm2);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/GCM2.dat"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout20 = openFileOutput("GCM2.dat", MODE_PRIVATE);
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(DatGCM2.this, DevMode.class);
