...
public class XBasic0001 extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xbasic0001);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/SOLUTION_SPECIES/DatabaseMakerSolutionPhaseDFTB.bas"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout60 = openFileOutput("DatabaseMakerSolutionPhaseDFTB.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout60);
                    outputWriter.write(BasFile60);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/DatabaseMakerSolutionPhaseDFTB.bas "+getFilesDir()+"/SOLUTION_SPECIES");
                try {
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(XBasic0001.this, DevMode.class);
