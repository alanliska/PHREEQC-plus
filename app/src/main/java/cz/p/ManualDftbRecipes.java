...
public class ManualDftbRecipes extends Dftb {
...
//    private WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manualdftbrecipes);
        ...
        pdfView.setPath(new File(getFilesDir()+"/docs/dftb+_recipes.pdf")); //Normal File loaction
