...
public class SSolmakerXtb extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ssolmakerxtb);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/PSEUDOPHASES/DatabaseMakerPseudoPhases_solid_solXTB.bas"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout70 = openFileOutput("DatabaseMakerPseudoPhases_solid_solXTB.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout70);
                    outputWriter.write(BasFile70);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/DatabaseMakerPseudoPhases_solid_solXTB.bas "+getFilesDir()+"/PSEUDOPHASES");
                try {
                    ...
                    exec("chmod -R 755 "+getFilesDir()+"/PSEUDOPHASES/DatabaseMakerPseudoPhases_solid_solXTB.b");
                } catch (Exception e) {
                }
            }
        };
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(SSolmakerXtb.this, DevMode.class);
