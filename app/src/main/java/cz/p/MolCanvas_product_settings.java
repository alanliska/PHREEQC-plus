...
public class MolCanvas_product_settings extends MolCanvas_product {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backgroundB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MolCanvas_product_settings.this, MolCanvas_product_colorPicker.class);
        ...
        defaultB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MolCanvas_product.setDefaultValues();
                Intent intent = new Intent(MolCanvas_product_settings.this, MolCanvas_product_settings.class);
                startActivity(intent);
            }
        });
        ...
        backB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MolCanvas_product_settings.this, MolCanvas_product.class);
                startActivity(intent);
            }
        });
