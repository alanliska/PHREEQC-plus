...
public class ManualPHREEQC2 extends Phreeqc {
...
//    private WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manualphreeqc2);
        ...
        pdfView.setPath(new File(getFilesDir()+"/docs/phreeqc_manual2_eqns.pdf")); //Normal File loaction
