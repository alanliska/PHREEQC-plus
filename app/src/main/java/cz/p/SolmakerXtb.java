...
public class SolmakerXtb extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.solmakerxtb);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/SOLUTION_SPECIES/DatabaseMakerSolutionPhaseXTB.bas"));
    }

    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                String BasFile60 = Content.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout60 = openFileOutput("DatabaseMakerSolutionPhaseXTB.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout60);
                    outputWriter.write(BasFile60);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/DatabaseMakerSolutionPhaseXTB.bas "+getFilesDir()+"/SOLUTION_SPECIES");
                try {
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(SolmakerXtb.this, DevMode.class);
