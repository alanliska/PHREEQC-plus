...
public class ModifyXtbSolid extends DevMode {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modifyxtbsolid);
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/XtbSolid.bas"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout70 = openFileOutput("XtbSolid.bas", MODE_PRIVATE);
                ...
                try {
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/XtbSolid.b "+getFilesDir()+"/XtbSolid.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/XtbSolid.b");
                } catch (Exception e) {
                }
            }
        };
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ModifyXtbSolid.this, DevMode.class);
