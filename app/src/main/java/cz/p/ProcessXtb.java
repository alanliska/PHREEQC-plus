...
public class ProcessXtb extends DevMode {
    ...
    {
        super.onStart();
        ContentDisplay(exec("cat "+getFilesDir()+"/ProcessXTB.txt"));
    }
    ...
    private View.OnClickListener CompileClick; {
        CompileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout50 = openFileOutput("ProcessXTB.txt", MODE_PRIVATE);
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ProcessXtb.this, DevMode.class);
