...
public class MolCanvas_reactant_settings extends MolCanvas_reactant {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backgroundB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MolCanvas_reactant_settings.this, MolCanvas_reactant_colorPicker.class);
        ...
        defaultB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MolCanvas_reactant.setDefaultValues();
                Intent intent = new Intent(MolCanvas_reactant_settings.this, MolCanvas_reactant_settings.class);
                startActivity(intent);
            }
        });
        ...
        backB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MolCanvas_reactant_settings.this, MolCanvas_reactant.class);
                startActivity(intent);
            }
        });
