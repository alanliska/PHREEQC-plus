...
OPEN "I", #21, "/data/data/cz.p/files/SOLUTION_SPECIES/Comp_s.par"
...
OPEN "I", #1, "/data/data/cz.p/files/SOLUTION_SPECIES/Thermochemistry_s.txt"
OPEN "O", #10, "/data/data/cz.p/files/SOLUTION_SPECIES/Database_s.dat"
CLOSE #10
OPEN "A", #10, "/data/data/cz.p/files/SOLUTION_SPECIES/Database_s.dat"
...
OPEN "I", #12, "/data/data/cz.p/files/SOLUTION_SPECIES/Ref_s.txt"
...
ENDIF
IF Cum_Probe = 0 THEN
PRINT #10, CHR$(035), "Hf�(aq) = "; H USING "######.##"; " kJ.mol-1 ("+ReferenceH$+")"; " ; ";
ENDIF
