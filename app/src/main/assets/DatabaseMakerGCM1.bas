...
OPEN "I", #21, "/data/data/cz.p/files/GCM1/Comp_GCM1.par"
INPUT #21, Temperature$, G_corr$, H_corr$, S_corr$, G0_corr$, H0_corr$, S0_corr$, Conversion$, G_electron$
...
OPEN "I", #1, "/data/data/cz.p/files/GCM1/Thermochemistry_s.txt"
OPEN "O", #10, "/data/data/cz.p/files/GCM1/Database_s.dat"
CLOSE #10
OPEN "A", #10, "/data/data/cz.p/files/GCM1/Database_s.dat"


#PRINT #10, "PHREEQC database fragment"
#PRINT #10, "========================="
#PRINT #10, "Generation from thermodynamic data"
#PRINT #10, "Parameters (read from the file Comp_s.par):"
...
#PRINT #10, "Temperature = ", Temperature
...
#PRINT #10, ""
#PRINT #10, "Data on aqueous species: file Thermochemistry_s.txt"
#PRINT #10, "(without header and blank lines)"
#PRINT #10, "Data on ref. elements and org. fragments: file Ref_s.txt"
#PRINT #10, "(without header and blank lines)"
#PRINT #10, ""
...
ReferenceG$ = MID$(LineData$, Lim1%+1, Lim2%-Lim1%-1)

G$ = MID$(LineData$, Lim2%+1, LenghtData%-Lim2%)
G = VAL(G$) * Conversion + G_corr
...
OPEN "I", #12, "/data/data/cz.p/files/GCM1/Ref_GCM1.txt"
...
RefG$ = MID$(Request$, Lim101%+1, LenghtRequest%-Lim101%)
RefG = VAL(RefG$) * Conversion + G0_corr


IF (Elmnt$ = RefFragm$ OR RefFragm$ = Elmnt$) AND (Elmnt$ <> "" OR RefFragm$ <> "") THEN 

Cum_G = Cum_G - ElmntCount * RefG
...
#PRINT #10, "# G�f = "; G USING "######.##"; " kJ.mol-1"
#IF H$ <> "" THEN
#PRINT #10, "# H�f = "; H USING "######.##"; " kJ.mol-1"
#ENDIF
#PRINT #10, "# Source: "; Source$
PRINT #10, "","log_k",
...
#ENDIF
IF Cum_Probe = 0 THEN
PRINT #10, CHR$(035), "Gf�(aq) = "; G USING "######.##"; " kJ.mol-1 ("+ReferenceG$+")"; " ; ";
ENDIF
#PRINT #10, CHR$(035), "S�(aq) = "; S USING "######.##"; " J.K-1.mol-1 ("+ReferenceS$+")"; " ; ";
PRINT #10, CHR$(035); Description$+"(aq)"
