...
PRINT #9, DatasetName$;"_forward ; -formula ";FormulaR1$;" -1 ";FormulaP1$;" 1 "
PRINT #9, DatasetName$;"_backward ; -formula ";FormulaP1$;" -1 ";FormulaR1$;" 1 "

PRINT #10, DatasetName$;"_forward ; -start ; 10 if (MOL("+CHR$(034)+FormulaR1$+CHR$(034)+") <= 1e-15) then goto 200 ; 100 moles = "+STR$(k_forward)+" "+CHR$(042)+" MOL("+CHR$(034)+FormulaR1$+CHR$(034)+") "+CHR$(042)+" TIME ; 200 SAVE moles ; -end"
PRINT #10, DatasetName$;"_backward ; -start ; 10 if (MOL("+CHR$(034)+FormulaP1$+CHR$(034)+") <= 1e-15) then goto 200 ; 100 moles = "+STR$(k_backward)+" "+CHR$(042)+" MOL("+CHR$(034)+FormulaP1$+CHR$(034)+") "+CHR$(042)+" TIME ; 200 SAVE moles ; -end"
